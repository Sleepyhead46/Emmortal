...
export default function OpenGraphImage() {
  return new ImageResponse(
    <div style={{ background: "#101010", color: "#f5f5f5", width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "72px", fontFamily: "Arial" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}><div style={{ color: "#a3a3a3", fontSize: 22, letterSpacing: "0.16em", textTransform: "uppercase" }}>Tools for the open web</div><div style={{ fontSize: 76, fontWeight: 700, letterSpacing: "-0.06em" }}>Simple tools.<br />Powerful results.</div></div>
